...
// http://localhost:8090/test/Info_Detail

@Controller
public class Info_DetailController {

	@Autowired
	private Test_Service service;
	
	@GetMapping("/test/Info_Detail")
...
//457.골프존조이마루 스포츠/문화예술 전체대관
		...
		Info_detailDTO info_detailDTO = new Info_detailDTO(num++,data.get(0));
		
		
		
		service.info_detail(info_detailDTO);
