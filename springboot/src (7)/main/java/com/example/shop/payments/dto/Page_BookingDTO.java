...
public class Page_BookingDTO {
	...
	public Page_BookingDTO() {

	}

	public Page_BookingDTO(int currentPage, int totalCount) {
	...
	public Page_BookingDTO(int currentPage, int totalCount, int main_code) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
	...
	public Page_BookingDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
