...
@Getter
@Setter
public class Main_host_UserPageDTO {
	...
	public Main_host_UserPageDTO() {
	}

	public Main_host_UserPageDTO(int main_code, String main_name, String main_address, String main_comment, double latitude,
