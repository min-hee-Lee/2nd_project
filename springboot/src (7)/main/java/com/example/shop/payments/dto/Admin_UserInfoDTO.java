...
public class Admin_UserInfoDTO {
	...
	private int blockCount = 8; // 한 페이지에 보여줄 레코드 수
	...
	public Admin_UserInfoDTO() {

	}
	
	

	public Admin_UserInfoDTO(int t_id, int main_code, int currentPage, int totalCount, int blockCount, int blockPage,
	...
	public Admin_UserInfoDTO(int currentPage, int totalCount) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
	...
	public Admin_UserInfoDTO(int currentPage, int totalCount, int main_code) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
		this.main_code = main_code;
		// 총 페이지수
	...
	public Admin_UserInfoDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
	...
	public String toString() {
		return "Admin_UserInfoDTO [t_id=" + t_id + ", filename=" + filename + ", t_username=" + t_username
				+ ", content=" + content + ", main_code=" + main_code + ", currentPage=" + currentPage + ", totalCount="
				+ totalCount + ", blockCount=" + blockCount + ", blockPage=" + blockPage + ", totalPage=" + totalPage
				+ ", startRow=" + startRow + ", endRow=" + endRow + ", startPage=" + startPage + ", endPage=" + endPage
				+ ", number=" + number + ", searchKey=" + searchKey + ", searchWord=" + searchWord + "]";
	}
