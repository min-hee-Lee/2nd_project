...
public class Page_MapDTO {
	...
	public Page_MapDTO(int currentPage, int totalCount) {
	...
	public Page_MapDTO(int currentPage, int totalCount, int main_code) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
	...
	public Page_MapDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
	...
	public String toString() {
		return "Page_MapDTO [main_code=" + main_code + ", currentPage=" + currentPage + ", totalCount=" + totalCount
				+ ", blockCount=" + blockCount + ", blockPage=" + blockPage + ", totalPage=" + totalPage + ", startRow="
				+ startRow + ", endRow=" + endRow + ", startPage=" + startPage + ", endPage=" + endPage + ", number="
				+ number + ", t_id=" + t_id + ", latitude=" + latitude + ", longitude=" + longitude + ", searchKey="
