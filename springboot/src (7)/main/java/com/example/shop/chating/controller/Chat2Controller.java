...
public class Chat2Controller {
	...
	public void addUser(@Payload ChatDto chatDto, SimpMessageHeaderAccessor headerAccessor) throws Exception {
...
//	}
	...
	public Map<String, Object> ChattingList(
		...
		List<Chat_main_imagesDTO> chatList = null;
		if(filename !=null && !filename.isEmpty()) {
			
			chatList = service.Chat_main_list(filename);
		...
		map.put("chat_main_list", chatList);
