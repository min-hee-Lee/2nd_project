...
public class New_User_WishListDTO {
	...
	private int blockCount = 25; // 한 페이지에 보여줄 레코드 수
	...
	public New_User_WishListDTO() {

	}
	
	

	public New_User_WishListDTO(int t_id, int main_code, int currentPage, int totalCount, int blockCount, int blockPage,
	...
	public New_User_WishListDTO(int currentPage, int totalCount) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
	...
	public New_User_WishListDTO(int currentPage, int totalCount, int main_code) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
		this.main_code = main_code;
		// 총 페이지수
	...
	public New_User_WishListDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
